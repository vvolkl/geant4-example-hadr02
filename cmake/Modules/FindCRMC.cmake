...
# -DCRMCROOT
set(CRMCROOT /usr/local)

find_library(CRMC_LIBRARIES libCrmc.so PATHS ${CRMCROOT}/lib)
if (CRMC_LIBRARIES)
   set(CRMC_FOUND TRUE)
   set(CRMC_INCLUDE_DIR ${CRMCROOT}/include)
   set(CRMC_LIBRARY_DIR ${CRMCROOT}/lib)
   set(CRMC_BUILD_DIR ${CRMCROOT})
